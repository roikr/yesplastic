...
{
	UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"WelcomeTitle",@"Welcome to YesPlastic Lite Edition") message:NSLocalizedString(@"WelcomeMessage",@"You can get more content any time by downloading the full version.") delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alertView show];
	[alertView release];	
}
